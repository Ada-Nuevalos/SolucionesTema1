...
#Planteamos 2 modelos lineales, uno para los datos de cada factor
Model3 <- lm(cabbages$HeadWt~cabbages$VitC,data=cabbages,subset = which(Cult == "c39"))
Modelo4 <- lm(cabbages$HeadWt~cabbages$VitC,data=cabbages,subset = which(Cult == "c52"))
#Representamos las rectas correspondientes a cada modelo lineal´
abline(Model3,lty=5)
abline(Modelo4)
